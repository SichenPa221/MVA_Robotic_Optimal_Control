%% iLQR applied to a planar manipulator for a tracking problem 
%% involving the center of mass (CoM) and the end-effector (batch formulation)
%% 
...
a = .7;
x0 = [pi/2-a; 2*a; -a; 3*pi/4; 3*pi/4]; %Initial pose
